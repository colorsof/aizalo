...
export const StickyScroll = ({
  ...
  const linearGradients = [
    ...
    "linear-gradient(to bottom right, rgb(147 51 234), rgb(236 72 153))", // purple-500 to pink-500
    "linear-gradient(to bottom right, rgb(34 197 94), rgb(6 182 212))", // green-500 to cyan-500
  ];
